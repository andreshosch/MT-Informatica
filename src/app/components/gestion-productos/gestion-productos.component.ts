...
export class GestionProductosComponent {
  ...
  constructor(private firestore: AngularFirestore, private _productosService: ProductosService, private fb: FormBuilder, private _mensaje: MensajeService, public _spinner: SppinerService) {
